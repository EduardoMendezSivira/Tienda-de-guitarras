export default function Header({ carrito, eliminarDelCarrito, incrementarCantidad, decrementarCantidad, vaciarElCarrito, carritoLleno, carritoTotal}) {
  ...
  return (
    <header className="grid grid-cols-1 md:grid-cols-5 h-88 bg-cover bg-center bg-blend-overlay bg-gradient-to-r from-black/70 to-black/70" style={{backgroundImage: `url('/img/header.jpg')`}}>
          ...
          <button className="btn btn-circle indicator col-start-7 fixed justify-self-end m-4" popoverTarget="popover-1" style={{ anchorName: "--anchor-1" } /* as React.CSSProperties */}>
